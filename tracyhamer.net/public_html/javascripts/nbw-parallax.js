...
$(document).ready(function() { //when the document is ready...
    ...
    var $fifthBG = $('#separator4');
	var bg5 = $("#separator4 .bg5");
	...
	$('#intro, #separator1, #separator2, #separator3, #separator4').bind('inview', function (event, visible) {
			if (visible == true) {
	...
	*/
	...
	function Move(){ 
        ...
        if ($fifthBG.hasClass("inview")){
			//call the newPos function and change the background position
			$fifthBG.css({'backgroundPosition': newPos(0, windowHeight, pos, 5850, 0)});
			//$secondBG.css({'backgroundPosition': newPos(50, windowHeight, pos, 1550, 0.3)});
			//call the newPos function and change the second background position
			bg5.css({'backgroundPosition': newPos(50, windowHeight, pos, 6610, 0.20)});
		}
